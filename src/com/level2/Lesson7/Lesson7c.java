...
//первый захватил lock1 и хочет захватить lock2, а второй захватил lock2 и хочет захватить lock1
//нужно сделать порядок блокировки одинаковым
//livelock -- объекты ожидают друг друга, делают работу, но без какого-то прогресса -- например один делает изменения, другой стирает
//lock starvation -- менее приоритетные потоки ждут всё время чтобы запуститься
